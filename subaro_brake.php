<html>
	...
	<div>
		<h1 style="color: white;text-align: center;"> Subaru WRX Brake</h1>
		
		<center>
		<img src= "image/S_brake.jpg" width="900" height="300"  / ></center>
		...
		<div style="color: red; font-size:40px; text-align:center;"> Subaru WRX Brake Parts</div><br><br>
	 	...
	 	<?php
			...
			if (!empty($result)) {
			    ...
			    while($row = $result->fetch_assoc()) {
			        ...
			        echo '<button><a href="bankInfo.php">BUY</button></a>';
			        echo '</div>';
			    }
			} else {
			    echo "0 results";
